...
public class ContractModel implements ContractModelProvider{
    ...
    public static ContractModel parse(Map<String, Object> contractAttributes) {
            ...
            try {
            	...
            	// ================================================================
            	// NEW: parse collateralModels list (null-safe — field is optional)
            	// ================================================================
            	List<String> cltvmdls = (List<String>)attributes.get("collateralModels");
            	System.out.println("**** fnp033: cltvmdls = <" + cltvmdls + ">");
