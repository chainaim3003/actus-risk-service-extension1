        ...
        for (Map.Entry<String, Object> entry : data.entrySet()) {
            if(entry.getKey().equals("contractStructure")){
                ...
                ((List<Map<String,Object>>)entry.getValue()).forEach(contractReference -> {
                    ...
                    contractReference.forEach((key,value) ->{
                        if(key.equals("object")){
                            ...
                            ((Map<String,Object>)value).forEach((childKey,childValue)-> objectValues.put(childKey, childValue));
                ...
                if (value instanceof List) {
                    ...
                    List<String> listAsStrings = rawList.stream()
                                                        .map(Object::toString)
                                                        .collect(Collectors.toList());
                    map.put(entry.getKey(), listAsStrings);
                } else {
